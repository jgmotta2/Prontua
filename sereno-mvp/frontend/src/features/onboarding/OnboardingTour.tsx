...
const STORAGE_KEY = 'sereno_tour_done';
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const driverObj = driver({
        ...
        overlayColor: '#2D3B36',
        overlayOpacity: 0.55,
        popoverClass: 'sereno-tour-popover',
        onDestroyStarted: () => {
        ...
        steps: [
          ...
          },
          {
            ...
            popover: {
              ...
              description:
                'Gráfico com os últimos 6 meses de faturamento. Cada barra representa o total de pagamentos recebidos naquele m��s.',
              side: 'top',
              align: 'start',
            },
          },
          ...
          },
          {
            popover: {
              title: '✅ Tudo pronto!',
              description:
                'Comece cadastrando seu primeiro paciente e agendando uma sessão. Qualquer dúvida, este tour pode ser revisitado em Configurações.',
              side: 'over',
              align: 'center',
            },
          },
